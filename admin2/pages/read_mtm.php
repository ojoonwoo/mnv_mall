<?
	...
	$hit_query = "UPDATE ".$_gl['board_mtm_table']." SET hit=hit+1 WHERE idx='".$idx."'";
	$result = mysqli_query($my_db, $hit_query); 

	$read_query = "SELECT * FROM ".$_gl['board_mtm_table']." WHERE idx='".$idx."'";
...
?>
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">1대1문의 읽기</h1>
      </div>
      <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group" style="text-align:center;">
                    ...
                    <input class="form-control" type="button" onclick="go_page('reply');" value="답글">
...
<script type="text/javascript">
	...
	function go_page(action) {
		switch (action) {
			case "list":
				location.href="list_mtm.php";
			break;
				
			case "reply":
				location.href="reply_mtm.php?idx=<?=$idx?>";
			break;
				
			case "edit":
				location.href="edit_mtm.php?idx=<?=$idx?>";
			break;
				
			case "delete":
				location.href="delete_mtm.php?idx=<?=$idx?>";
			break;
		}
	}
