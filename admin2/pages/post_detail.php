      ...
      <div class="panel-body">
        <div class="panel-body">
          <div class="table-responsive" id="add_post">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                <tr>
                  <td>포스트 제목</td>
                  <td colspan="2">
                    <input class="form-control" id="post_title" style="width:100%" value="<?=$post_info['post_title']?>">
                  </td>
                </tr>
                <tr>
                  <td colspan="3"> 내 용 </td>
            ...
            <button type="button" class="btn btn-danger btn-lg btn-block" id="submit_btn15">완 료</button>
          </div>
          <!-- /.table-responsive -->
        </div>
      </div>
