<?
	...
	$read_query = "SELECT * FROM ".$_gl['board_review_table']." WHERE idx='".$idx."'";
	...
	function go_page(action) {
		switch (action) {
			case "list":
				...
				break;
			case "reply":
				location.href="reply_review.php?idx=<?=$idx?>";
				break;
			case "edit":
				location.href="edit_review.php?idx=<?=$idx?>";
				break;
			case "delete":
				location.href="delete_review.php?idx=<?=$idx?>";
				break;
		}
	}
