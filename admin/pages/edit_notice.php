<?
	...
	$s_query = "SELECT * FROM ".$_gl['board_notice_table']." WHERE idx='".$idx."'";
              ...
              <form method="post" id="modify_form" role="form">
                <div class="col-lg-12">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="showYN" name="showYN" value="<?=$data['showYN']?>">
                  </div>
                  <div class="form-group">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group" style="text-align:center;">
                      <input class="form-control" type="button" id="edit_notice" value="확인">
	...
	$('#edit_notice').on('click', function(){
		...
		$.ajax({
			...
			success: function(res){
				...
				{
					alert("수정되었습니다.");
					location.href="read_notice.php?idx=<?=$idx?>";
				}else{
					alert("수정실패");
					location.reload();
				}
