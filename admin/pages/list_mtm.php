...
?>
  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">1대1 문의 리스트</h1>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- /.row -->
      ...
      <div class="panel-body">
        <div class="panel-body">
          ...
          <div class="table-responsive">
            <table width="100%" class="table table-striped table-bordered table-hover" id="mtm_list">
            </table>
          </div>
          <!-- /.table-responsive -->
        </div>
...
<script>
	...
	$(document).ready(function() {
		// 멤버 리스트
		show_mtm_list("mtm_list");

		// 테이블 api 세팅
		var table   = $('#mtm_list').DataTable({
			"columnDefs": [ {
				"searchable": false,
				"orderable": false,
				"targets": 0
