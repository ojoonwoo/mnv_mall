<?
	...
	$idx = $_GET['idx'];
	$parent_query = "SELECT * FROM ".$_gl['board_mtm_table']." WHERE idx='".$idx."'";
...
?>
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">1대1문의 답변 달기</h1>
      </div>
      <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
              ...
              <form method="post" id="modify_form" role="form">
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="user_id" name="user_id" value="<?=$parent_data['user_id']?>" disabled>
                  </div>
                  <div class="form-group">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group" style="text-align:center;">
                      <input class="form-control" type="button" id="reply_mtm" value="확인">
  ...
  $('#reply_mtm').on('click', function(){
    ...
    $.ajax({
      ...
      data: {
        exec           : "reply_mtm",
        user_id        : user_id,
        user_email     : "<?=$parent_data['user_email']?>",
        subject        : subject,
