          <div class="area_list_title">
            <span class="list_title"><img src="<?=$_mnv_PC_images_url?>title_newProduct.png" alt="신제품 상품목록"></span>
          </div>
          <div class="list_product clearfix">
<?
	$new_goods_info		= select_new_goods_info($site_option['new_goods_flag'],5);
	$i	= 0;
