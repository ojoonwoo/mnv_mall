<?
  ...
  $order_type = $_REQUEST['ordertype'];
	...
	{
		echo "<script>location.href='".$_mnv_PC_url."order/order.php?ordertype=".$order_type."';</script>";
	}
?>
  <body>
              ...
              <div class="area_input member">
                 <div class="area_inner">
                   ...
                   <div class="group_input">
                     ...
                     <input type="password" name="mb_password" id="mb_password" class="mb_input autocomplete-off" autocomplete="off" data-direction="<?=$order_type?>">
                   </div>
                   <div class="group_input">
                     <input type="button" class="btn login" id="mb_login" value="로그인" data-direction="<?=$order_type?>">
                   </div>
